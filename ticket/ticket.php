<!-- Page: Ticket Management | Refactor: format & comments only (no logic change) -->
<!DOCTYPE html>
<html lang="en">
<?php $menu = "ticket"; ?>
...
<head>
    ...
    <title>Innovation | All Ticket</title>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        if (isset($_POST['search'])) {
                            ...
                            if (
                                $search != $search_backup || $status != $status_backup || $requester != $requester_backup || $work_type  != $work_type_backup
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-4">
                                        ...
                                        <div class="small-box bg-info">
                                            ...
                                            $query2 = "SELECT DISTINCT COUNT(`id`) as AMP FROM tickets ";
                                            $query1 = $query2 . $_where . "" . " ORDER BY id DESC ";
                                ...
                                <div class="col-md-12">
                                    <div class="card card-outline card-info">
                                        <div class="card-header ">
                                            <h3 class="card-title font1">Search</h3>
                                                ...
                                                <td scope="col" class="text-nowrap text-center" height="" width="100">
                                                    <a href="" class="img-fluid" data-toggle="modal" data-target="#modal-xl<?php echo $res_search["work_id"]; ?>">
                                                        ...
                                                        if ($res_search["file_im1"] == '') {
                                                            ...
                                                            echo '<img class=""  width="40" height="25" src="../img/camera.png"';
                                                        }
                                                        ?>
                                                    </a>
                                                    <!-- /.modal-content -->
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="div">
                                                                        <div class="col col-12">
                                                                            ...
                                                                            <a href="../example/<?php echo $res_search["file_im1"]; ?>" data-lightbox="image-1" data-title="../example/<?php echo $res_search["file_im1"]; ?>  (<?php echo $res_search["file_im1"]; ?>)" class="img-fluid ">
                                                                                <?php
                                                                                if ($res_search["file_im1"] == '') {
                                                                                    echo "<span class='badge badge-warning'>No Image</span>";
                                                                                } elseif ($res_search["file_im1"]) {
                                                                                    echo '<img class=""  width="300" height="450" src="../example/' . $res_search["file_im1"] . '"'; //imgx
                                                                                }
                                                                                ?>
                                                                            </a>
                                                                            <a href="../example/<?php echo $res_search["file_im2"]; ?>" data-lightbox="image-1" data-title="../example/<?php echo $res_search["file_im2"]; ?>  (<?php echo $res_search["file_im2"]; ?>)" class="img-fluid ">
                                                                                <?php
                                                                                if ($res_search["file_im2"] == '') {
                                                                                    echo "<span class='badge badge-warning'>No Image</span>";
                                                                                } elseif ($res_search["file_im2"]) {
                                                                                    echo '<img class=""  width="300" height="450" src="../example/' . $res_search["file_im2"] . '"'; //imgx
                                                                                }
                                                                                ?>
                                                                            </a><br>
                                                                            <a href="../example/<?php echo $res_search["file_im3"]; ?>" data-lightbox="image-1" data-title="../example/<?php echo $res_search["file_im3"]; ?>  (<?php echo $res_search["file_im3"]; ?>)" class="img-fluid ">
                                                                                <?php
                                                                                if ($res_search["file_im3"] == '') {
                                                                                    echo "<span class='badge badge-warning'>No Image</span>";
                                                                                } elseif ($res_search["file_im3"]) {
                                                                                    echo '<img class=""  width="300" height="450" src="../example/' . $res_search["file_im3"] . '"'; //imgx
                                                                                }
                                                                                ?>
                                                                            </a>
                                                                            <a href="../example/<?php echo $res_search["file_im4"]; ?>" data-lightbox="image-1" data-title="../example/<?php echo $res_search["file_im4"]; ?>  (<?php echo $res_search["file_im4"]; ?>)" class="img-fluid ">
                                                                                <?php
                                                                                if ($res_search["file_im4"] == '') {
                                                                                    echo "<span class='badge badge-warning'>No Image</span>";
                                                                                } elseif ($res_search["file_im4"]) {
                                                                                    echo '<img class=""  width="300" height="450" src="../example/' . $res_search["file_im4"] . '"'; //imgx
                                                                                }
                                                                                ?>
                                                                            </a><br>
                                                ...
                                                <td scope="col" class="text-nowrap text-center" height="" width="100">
                                                    <a href="" class="img-fluid" data-toggle="modal" data-target="#modal-xll<?php echo $res_search["work_id"]; ?>">
                                                        ...
                                                        if ($res_search["file_test"] == '') {
                                                            ...
                                                            echo '<img class=""  width="40" height="25" src="../img/camera.png"'; //imgx
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="div">
                                                                        <div class="col col-12">
                                                                            ...
                                                                            <a href="../test/<?php echo $res_search["file_test"]; ?>" data-lightbox="image-1" data-title="../test/<?php echo $res_search["file_test"]; ?>  (<?php echo $res_search["file_test"]; ?>)" class="img-fluid ">
                                                                                <?php
                                                                                if ($res_search["file_test"] == '') {
                                                                                    echo "<span class='badge badge-warning'>No Image</span>";
                                                                                } elseif ($res_search["file_test"]) {
                                                                                    echo '<img class=""  width="300" height="450" src="../test/' . $res_search["file_test"] . '"'; //imgx
                                                                                }
                                                                                ?>
                                                                            </a>
                ...
                <div>
                    <a href="../test/<?php echo $res_search["file_test"]; ?>" data-lightbox="image-1" data-title="../test/<?php echo $res_search["file_test"]; ?>  (<?php echo $res_search["file_test"]; ?>)" class="img-fluid ">
                        ...
                        if ($res_search["file_test"] == '') {
                            ...
                            echo '<img class="imgx"  width="60" height="45" src="../test/' . $res_search["file_test"] . '"';
                        }
                        ?>
                    </a>
                </div>
