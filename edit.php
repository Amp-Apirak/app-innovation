                            ...
                            if ($result) {
                                //     // <!-- sweetalert -->
                                    echo '<script>
                                        ...
                                        $sToken = "tWqvxinV7NsZKTMs544JF5uMJsdsvjDUIxyLT25iDEZ"; //0BQC5bXVxHFLoFUn3GL66B93UL4rProwuATOIZ7w6hi
                                        ...
                                        $sMessage .= //http://iss.pointit.co.th/pms"📢 Subject : ".$subject."\n\n";
                                        $sMessage .= "-------------------------- \n";
